<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        ...
        <div class="x_content">
            <br />
            <form method="POST" action="<?= base_url("jadwal/update_jadwal/" . $col['id_jadwal']) ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">

                <div class="item form-group ">
                    <label class="col-form-label col-md-3 col-sm-3 label-align">Pelatih</label>
                    <?php $data = $this->db->get_where('tabel_pelatih', ['id_pelatih' => $col['id_pelatih']])->row_array(); ?>
                    <div class="col-md-6 col-sm-6 ">
                        <select class="form-control" id="pelatih" name="pelatih">
                            <option hidden value="<?= $data['id_pelatih']; ?>"> <?= $data['nama_pelatih']; ?> </option>
                ...
                <div class="item form-group ">
                    ...
                    <?php $data_gk = $this->db->get_where('tabel_pelatih', ['id_pelatih' => $col['id_pelatih_gk']])->row_array(); ?>
                    <div class="col-md-6 col-sm-6 ">
                        <select class="form-control" id="pelatih" name="pelatih_gk">
                            <option hidden value="<?= $data_gk['id_pelatih']; ?>"> <?= $data_gk['nama_pelatih']; ?> </option>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <input type="text" value="<?= $col['waktu_mulai'] ?>" id="waktu_mulai" required="required" name="waktu_mulai" class="form-control ">
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <input type="text" value="<?= $col['waktu_selesai'] ?>" id="waktu_selesai" name="waktu_selesai" required="required" class="form-control">
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <select class="form-control" id="kelompok_usia" name="kelompok_usia">
                            <option hidden> <?= $col['kelompok_usia'] ?> </option>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <select class="form-control" id="tempat" name="tempat">
                            <option hidden> <?= $col['tempat'] ?> </option>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <input id="tanggal" class="form-control" type="date" name="tanggal" value="<?= $col['tanggal'] ?>">
                    </div>
                </div>
