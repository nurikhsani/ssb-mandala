<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        ...
        <div class="x_content">
            <br />
            <form method="post" action="<?php echo base_url('nilai/i_nilai') ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                <div class="item form-group">
                    <label class="col-form-label col-md-3 col-sm-3 label-align">Nama Siswa</label>
                    <div class="col-md-6 col-sm-6 ">
                        <input type="text" disabled class="form-control" id="nama" name="nama_siswa" aria-describedby="emailHelp" value="<?= $siswa->nama_siswa; ?>">
                    </div>
                </div>
                <div class="item form-group">
                    <label class="col-form-label col-md-3 col-sm-3 label-align">Posisi</label>
                    <div class="col-md-6 col-sm-6 ">
                        <input type="text" disabled class="form-control" id="nama" name="nama_siswa" aria-describedby="emailHelp" value="<?= $siswa->posisi; ?>">
                    </div>
                </div>
                <div class="item form-group">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <select class="form-control" id="posisi" name="nilai_1">
                            <option hidden> Pilih Nilai </option>
                ...
                <input type="hidden" value=<?= $tahun; ?> name="waktu" id="waktu" />
