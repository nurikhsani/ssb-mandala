<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        ...
        <div class="x_content">
            <br />
            <form method="post" action="<?php echo base_url('dashboard/e_DataDiri/' . tampilSession('id_user')) ?>" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <input required type="text" disabled value="<?= $col['nama_siswa']; ?>" class="form-control" id="nama" name="nama_siswa" aria-describedby="emailHelp" placeholder="Masukan nama lengkap">
                    </div>
                </div>
                <div class="item form-group">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <select class="form-control" id="posisi" name="posisi" disabled>
